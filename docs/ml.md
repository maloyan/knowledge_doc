...
TODO Решающее дерево, бинаризация признаков, алгоритм построения. Решающие деревья, случайный лес, градиентный бустинг. Методы их обучения, критерий информативности, критерий остановки
...
Градиентный бустинг (gradient boosting) - это метод машинного обучения, который строит композицию алгоритмов, называемых базовыми алгоритмами, чтобы предсказывать результаты. Каждый новый базовый алгоритм добавляется к композиции для корректировки ошибок, сделанных предыдущими алгоритмами.
