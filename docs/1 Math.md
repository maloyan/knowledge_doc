...
сказать, что происходит с функцией: касательная идёт вверх $\tg{\alpha}>0$ - функция возрастает, касательная идёт вниз $\tg{\alpha}<0$ - функция убывает. Идея поиска максимума и минимума, известная со школы - найти нули производной (таблицу производных для нас
