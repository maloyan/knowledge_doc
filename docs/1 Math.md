...
4. Метод главных компонент. SVD - разложение матриц.\
...
5. Предел, производная, дифференциал. Производная по направлению,
...
6. Метод множителей Лагранжа. Метод Каруша-Кунна-Таккера.
...
7. Метод наименьших квадратов. Метод градиентного спуска.
...
9. Дискретные и непрерывные случайные величины. Функции плотности и
распределения.\
...
11. Мода, медиана, математическое ожидание, дисперсия, ковариация,
...
$$\bar x = \frac{x_1 k_1 \,+ \,x_2 k_2 \,+\, \dots \,+ \,x_n k_n}{N}= \,x_1 \frac{k_1}{N} \,+\, x_2 \frac{k_2}{N} \,+\, \dots \,+\, x_n \frac{k_n}{N} \, =$$
...
Есть один нюанс: если мы считаем длину в сантиметрах, то разброс в
...
$$cov(x)_{i, j} = cov(x_i, x_j), \qquad corr(x)_{i, j} = corr(x_i, x_j)$$
